<?php 
    ...
    if ($name != '' || $status != '' || $id != '' || $price != '') {
    	if($status != ''){
    		$search_status=" AND pro_status = '$status'";
    	}
    	if($id != ''){
    		$search_id=" AND pro_id = '$id'";
    	}
    	if($price != ''){
    		switch ($price) {
    			case '1':
    				$search_price=" AND pro_price < 1000000";
    				break;
    			case '2':
    				$search_price=" AND pro_price >= 1000000 AND pro_price <= 5000000";
    				break;
    			case '3':
    				$search_price=" AND pro_price >= 5000000 AND pro_price <= 10000000";
    				break;
    			case '4':
    				$search_price=" AND pro_price >= 10000000 AND pro_price <= 15000000";
    				break;
    			case '5':
    				$search_price=" AND pro_price >= 15000000";
    				break;
    			default:
    				# code...
    				break;
        ...
        $params="WHERE pro_name LIKE '%$name%' ".$search_status.$search_id.$search_price;
        $res['searchName'] = $name;
