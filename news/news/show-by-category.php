<?php 
    ...
    $sql = "SELECT * FROM news WHERE cate_id='$category' AND news_status='0'";
    ...
    $sql2 = "SELECT * FROM news WHERE cate_id='$category' AND news_status='0' ORDER BY news_id DESC LIMIT $start,".$res['limit'];
