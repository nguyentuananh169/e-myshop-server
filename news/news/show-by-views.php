<?php 
    ...
    $sql = "SELECT * FROM news WHERE news_status='0' ORDER BY news_views DESC";
    ...
    $sql2 = "SELECT * FROM news WHERE news_status='0' ORDER BY news_views DESC LIMIT $start,".$res['limit'];
