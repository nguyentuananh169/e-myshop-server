<?php 
    ...
    $params="WHERE news_title LIKE '%$title%'";
    if ($category != '') {
        $params.=" AND cate_id = '$category'";
    }

    $sql = "SELECT * FROM news ".$params;
    ...
    $sql2 = "SELECT * FROM news ".$params." ORDER BY news_id DESC LIMIT $start,".$res['limit'];
