<?php 
    ...
    $sql = "SELECT * FROM comments WHERE cmt_parent_id = 0";
    ...
    $sql = "SELECT * FROM comments INNER JOIN user ON comments.user_id = user.user_id WHERE cmt_parent_id = 0 ORDER BY cmt_id DESC LIMIT $start,".$res['limit'];
    $rl = mysqli_query($conn, $sql);
